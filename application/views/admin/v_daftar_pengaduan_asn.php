...
<head>
  ...
  <title>BKD Jateng | Pengaduan ASN</title>
...
<div class="wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php 
					...
					foreach ($data as $i) :
                       $no++;
                       $id_pelapor_pengaduan_asn=$i['ID_PELAPOR_PENGADUAN_ASN'];
                       $nama=$i['NAMA'];
                       $telepon=$i['TELEPON'];
                       $email=$i['EMAIL'];
                       $alamat=$i['ALAMAT'];
                       ...
                       $kabupaten=$i['nama'];
                       $deskripsi_pelaporan=$i['DESKRIPSI_PELAPORAN'];
                       $nip_terlapor=$i['NIP_TERLAPOR'];
                       $nama_terlapor=$i['NAMA_TERLAPOR'];
                       $saksi=$i['SAKSI'];
                       $identitas_terlapor=$i['IDENTITAS_TERLAPOR'];
                       $tanggal=$i['TANGGAL_PENGADUAN'];
                ...
                <tr>
                  ...
                  <td><?php echo $identitas_terlapor?></td>
                  <td><?php echo $nip_terlapor?></td>
                  <td><?php echo $nama_terlapor?></td>
                  <td><?php echo $deskripsi_pelaporan?></td>
                  <td><?php echo $saksi;?></td>
                  <td><?php echo $tanggal;?></td>
                  
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_pelapor_pengaduan_asn;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http://mfikri.com"></a>.</strong> All rights reserved.
  </footer>
