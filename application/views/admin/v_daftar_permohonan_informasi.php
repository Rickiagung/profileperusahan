...
<head>
  ...
  <title>BKD Jateng | Permohonan Informasi</title>
          ...
          <div class="box">
            ...
            <tbody>
				...
				<?php 
					...
					foreach ($data as $i) :
                       $no++;
                       $id_permohonan_informasi=$i['ID_PERMOHONAN_INFORMASI'];
                       $nama=$i['NAMA'];
                       $identitas=$i['IDENTITAS'];
                       $nomor_identitas=$i['NOMOR_IDENTITAS'];
                       $unitkerja=$i['UNIT_KERJA'];
                       $subunitkerja=$i['SUB_UNIT_KERJA'];
                       $alamat=$i['ALAMAT'];
                       $provinsi=$i['nama_provinsi'];
                       $kabupaten=$i['nama'];
                       $bidang=$i['BIDANG'];
                       $kategori=$i['KATEGORI'];
                       $deskripsi_permohonan=$i['DESKRIPSI_PERMOHONAN'];
                ...
                <tr>
                  ...
                  <td><?php echo $nomor_identitas;?></td>
                  <td><?php echo $unitkerja;?></td>
                  <td><?php echo $subunitkerja;?></td>
                  <td><?php echo $alamat;?></td>
                  <td><?php echo $provinsi;?></td>
                  <td><?php echo $kabupaten;?></td>
                  <td><?php echo $bidang;?></td>
                  <td><?php echo $kategori;?></td>
                  <td><?php echo $deskripsi_permohonan;?></td>
                  <td><?php echo $tanggal_permohonan;?></td>
                  
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_permohonan_informasi;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
